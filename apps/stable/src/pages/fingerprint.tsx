...
import styles from "@/styles/pages/fingerprint.module.scss";
  ...
  return (
    <div className={styles.fingerprintContainer}>
      ...
      <div className={styles.mainSection}>
        ...
        <div className={styles.fingerprintButtonContainer}>
          <button className={styles.fingerprintButton} onClick={() => auth()}>
            <span className="print print--under">
              <svg viewBox="0 0 98 109" xmlns="http://www.w3.org/2000/svg">
                ...
                />
                <path
                  d="m32.92 99.221c10.667-12.333 16-23.333 16-33v-17"
                  pathLength="1"
                />
              </svg>
            </span>
